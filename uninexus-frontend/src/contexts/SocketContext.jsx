...
const SOCKET_URL =
    import.meta.env.VITE_SOCKET_URL || apiBase.replace(/\/api\/?$/, '') || 'http://localhost:3000';
...
export const SocketProvider = ({ children }) => {
    ...
    useEffect(() => {
        ...
        const handleNewChatGroupMessage = (msg) => {
            ...
            const msgChatGroupId =
                typeof msg.chatGroup === 'string' ? msg.chatGroup : msg.chatGroup?._id;
    ...
    const joinChatGroup = useCallback(
        (chatGroupId) => {
